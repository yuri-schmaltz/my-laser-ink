...
This page explains how to export G-code from Laser Ink and customize export settings for your machine.
...
- **LightBurn** - Full laser software (alternative to Laser Ink)
...
- [Importing Files](importing.md) - Getting designs into Laser Ink
